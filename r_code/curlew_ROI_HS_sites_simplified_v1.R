...
site.pop      <- 16                     # number of breed pairs on site
# monaghan = 5
# donegal = 4
# stacks = 1
# ree = 15
...
names(PVA_mon_means) <- c("base", "removed", "HS", "years")
names(PVA_don_means) <- c("base", "removed", "HS", "years")
names(PVA_stacks_means) <- c("base", "removed", "HS", "years")
names(PVA_ree_means) <- c("base", "removed", "HS", "years")
names(PVA_corrib_means) <- c("base", "removed", "HS", "years")


num_clutches <- "num_clutches"
scenario <- "scenario"
pop_size <- "population size (breeding pairs)"
gathercols <- c("base", "removed", "HS")
