...
write.table(simul.in,
            "data/ROI_HS_scenario_A1_base_hplr_parameters_2.csv",
            sep = ",",
            row.names = FALSE)
...
# Write to save file
saveRDS(ROI.sim.out,
        "data/ROI_HS_A1_sims_hplr_3.RDS")
...
write.table(ROI.sim.out.df.long,
            "data/ROI_HS_A1_means_hplr_fullsims_3.csv",
            sep = ",",
            row.names = FALSE)
...
write.table(ROI.sim.out.df.match,
            "data/ROI_HS_A1_hplr_means_match1_1.csv",
            sep = ",",
            row.names = FALSE)
